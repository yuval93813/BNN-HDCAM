...
def process_weights_and_voltages(weights, voltages, activation, one_word, zero_word, hdcam, powerSupply, MnistLable):
    ...
    for sub_array in weights:
        ...
        active1 = (low_32 << 32) | low_32
        active2 = (high_32<<32 ) | high_32
        high_32 = (activation[0][1] >> 32) & 0xFFFFFFFF
        low_32 = activation[0][1] & 0xFFFFFFFF
        active3 = (low_32<<32) | low_32
        active4 = (high_32<<32) | high_32
        ...
        for row in voltages:
            ...
            weightlow = (low_32<<32) | low_32
            weighthigh = (high_32<<32) | high_32
    ...
    file_path = "resultsDualWeight.txt"
