...
os.makedirs(os.path.dirname("C:/Users/User/Desktop/BNN-HDCAM/MnistWWResults.txt"), exist_ok=True)
with open("C:/Users/User/Desktop/BNN-HDCAM/MnistWWResults.txt", "w") as result_file:
    for hd in range(0,32):
        labelmiss = {}
        count_res = 0
        top_2_count = 0
